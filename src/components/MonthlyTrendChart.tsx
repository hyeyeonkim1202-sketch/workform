...
import { getMonthlyData, getUniqueCategories, getCategoryColor } from '@/lib/dataUtils';
...
export default function MonthlyTrendChart({ tasks }: Props) {
          ...
          <LineChart data={data} margin={{ top: 4, right: 8, left: -20, bottom: 0 }}>
            ...
            {categories.map(cat => (
              <Line
                ...
                stroke={getCategoryColor(cat)} strokeWidth={2}
